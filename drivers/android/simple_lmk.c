...
>>>>>>> 9fe56d641282 (simple_lmk: Skip victim reduction when all victims need to be killed)
{
...
>>>>>>> a5e7e17bc55e (simple_lmk: Optimize victim finder to eliminate hard-coded adj ranges)
{
