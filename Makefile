...
override ARCH		:= arm64
override CROSS_COMPILE	:= $(CCACHE) $(PWD)/arm64-gcc/bin/aarch64-elf-
override CROSS_COMPILE_ARM32	:= $(CCACHE) $(PWD)/arm32-gcc/bin/arm-eabi-
...
ifdef CONFIG_LTO
LTO_CFLAGS    := -flto -flto=auto -fno-fat-lto-objects \
